...
test(
  ...
  async () => {
    ...
    assert.match(
      generated,
      /^\| Название \| Ранг \| Урон \| Эффекты \| Краткое описание \| Полное описание \| Частота использования \| Навык \| Цена в действиях \| Дальность \| Цели \| Зона \| Защита \| Длительность \| Цена в очках развития \| Масштаб по рангу персонажа \|$/m
    );
    assert.match(
      generated,
...
test(
  ...
  async () => {
    ...
    assert.match(
      artifactRow ?? '',
      /^\| Контур «Блэкаут» \| 1 \|  \|  \| .* \| .* \|  \| Действие \| 30 м \| Все цели в зоне \| Круг, радиус 8 м \|  \| До конца сцены \|$/u
    );
  }
);
