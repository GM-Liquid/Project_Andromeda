...
test(
  ...
  async () => {
    ...
    assert.match(
      generated,
      /^\| Название \| Ранг \| Урон \| Краткое описание \| Полное описание \| Частота использования \| Навык \| Цена в действиях \| Дальность \| Цели \| Зона \| Защита \| Длительность \| Цена в кредитах \|$/m
    );
