...
Во время переговоров ведущий назначает NPC четыре временных параметра и особенности — **интерес, терпение, стремления и триггеры**. Герои могут заключить выгодную сделку, если максимизируют интерес NPC, приводя аргументы, которые отсылают к стремлениям NPC и избегают их триггеров — но всё это нужно сделать до того, как терпение NPC иссякает.
### Интерес
...
REQ. CHECK: сверить проверки переговоров с новой системой рангов задач, исходов и отдельной прокачкой Контроля.
...
REQ. CHECK: сверить, как успех с ценой и критический успех влияют на Интерес и Терпение.
