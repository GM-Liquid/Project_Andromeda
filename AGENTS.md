...
| data/
| '- gear/
|    '- catalog/ <- public fallback mirror of the canonical armor / equipment / abilities JSON catalogs plus the temporary concept-abilities catalog used by Quartz when the private repo is unavailable
